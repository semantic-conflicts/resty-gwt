...
public class DirectRestServiceInterfaceClassCreator extends DirectRestBaseSourceCreator {
  public static String DIRECT_REST_SERVICE_SUFFIX="_DirectRestService";
  ...
  @Override public ClassSourceFileComposerFactory createComposerFactory() throws UnableToCompleteException {
  ...
  public String getMethodParameters(  JMethod method){
  ...
  public String getMethodCallback(  JMethod method){
  ...
  public String getAnnotationsAsString(  Annotation[] annotations){
    StringBuilder result=new StringBuilder("");
  ...
  public String[] getAnnotationsAsStringArray(  Annotation[] annotations){
